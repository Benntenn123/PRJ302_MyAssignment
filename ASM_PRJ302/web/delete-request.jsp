...
<head>
    ...
    <title>Xóa Đơn Xin Phép - Helios</title>
...
<body class="body-home body-home-dashboard">
                    ...
                    <ul class="navbar-nav home-navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item active" href="delete-request.jsp">Xóa Đơn Xin Phép</a></li>
    ...
    <main class="home-main home-main-dashboard">
        <section class="function-page-section">
            <div class="container">
                <h2>Chức năng: Xóa Đơn Xin Phép</h2>
                <p>Đây là giao diện cho chức năng **Xóa Đơn Xin Phép**.</p>
                </div>
        </section>
    </main>
