...
<head>
    ...
    <title>Sửa Đơn Xin Phép - Helios</title>
    ...
    <div id="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="edit-request.jsp"><i class="fas fa-edit"></i> Edit Request</a>
                </li>
                <li class="nav-item">
        ...
        <div id="main-content">
            ...
            <section class="function-page-section">
                <h2>Chức năng: Sửa Đơn Xin Phép</h2>
                <p>Đây là giao diện cho chức năng <strong>Sửa Đơn Xin Phép</strong>.</p>
            </section>
        </div>
    </div>
